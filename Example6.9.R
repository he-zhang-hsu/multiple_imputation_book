...
# Read the original complete data of birthweight;
...
# Data manipulation to stablize the mixture model fitting;
T=rep(NA, rowobs);
T[1]=1;
T[rowobs]=2;

# fit mixture models to the complete data;
...
# using the last set of imputations;

# Fig. 6.7 bottom right;
