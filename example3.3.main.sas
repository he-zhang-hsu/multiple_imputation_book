...
/* the following code is to merge the imputed income file */
/* with NHIS family and household file */
/* also to get the survey sampling strata and variance */
...
****************************************************************
Chaper 3, Example 3.3
****************************************************************;

/* the 1st imputation */
/* note that we need to use survey sampling strata and psu to get the correct */
/* weighted estimates and its variance */
...
/* we can do the above for the other four imputed datasets to get the */
/* the respective weighted mean and variance estimates */
